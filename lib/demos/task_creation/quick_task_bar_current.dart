...
class QuickTaskBarCurrent extends StatefulWidget {
  final VoidCallback onClose;
  final VoidCallback onSubmit;

  const QuickTaskBarCurrent({
    super.key,
  ...
  @override
  State<StatefulWidget> createState() => _QuickTaskBarCurrentState();
}

class _QuickTaskBarCurrentState extends State<QuickTaskBarCurrent> {
